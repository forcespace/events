;/* Start:"a:4:{s:4:"full";s:79:"/ispring_content/content/js-min/lib/jquery/jquery-1.11.3.min.js?171093790995027";s:6:"source";s:63:"/ispring_content/content/js-min/lib/jquery/jquery-1.11.3.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
!function(e, t) {
  ...
  w.fn = w.prototype = {
      ...
      for ("boolean" == typeof o && (l = o,
        ...
        if (null != (r = arguments[a]))
          for (n in r)
            i = o[n],
              t = r[n],
            o !== t && (l && t && (w.isPlainObject(t) || (e = w.isArray(t))) ? (i = e ? (e = !1,
    ...
    w.extend({
      ...
      makeArray: function(e, t) {
        t = t || [];
        return null != e && (f(Object(e)) ? w.merge(t, "string" == typeof e ? [e] : e) : s.call(t, e)),
          t
      },
      ...
      proxy: function(e, t) {
        ...
        return "string" == typeof t && (r = e[t],
          t = e,
          e = r),
          w.isFunction(e) ? (n = c.call(arguments, 2),
            (r = function() {
  ...
  var p = function(n) {
    ...
    var e, f, x, o, r, p, h, m, w, u, c, g, T, i, v, y, a, s, b, C = "sizzle" + +new Date, N = n.document, E = 0, k = 0, l = oe(), S = oe(), A = oe(), D = function(e, t) {
      return e === t && (c = !0),
        0
    }, j = {}.hasOwnProperty, L = [], H = L.pop, q = L.push, _ = L.push, M = L.slice, F = function(e, t) {
      for (var n = 0, r = e.length; n < r; n++)
        if (e[n] === t)
          return n;
      return -1
    }, O = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", B = "[\\x20\\t\\r\\n\\f]", P = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", R = P.replace("w", "w#"), W = "\\[" + B + "*(" + P + ")(?:" + B + "*([*^$|!~]?=)" + B + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + R + "))|)" + B + "*\\]", $ = ":(" + P + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + W + ")*)|.*)\\)|)", z = new RegExp(B + "+","g"), I = new RegExp("^" + B + "+|((?:^|[^\\\\])(?:\\\\.)*)" + B + "+$","g"), X = new RegExp("^" + B + "*," + B + "*"), U = new RegExp("^" + B + "*([>+~]|" + B + ")" + B + "*"), V = new RegExp("=" + B + "*([^\\]'\"]*?)" + B + "*\\]","g"), J = new RegExp($), Y = new RegExp("^" + R + "$"), G = {
      ID: new RegExp("^#(" + P + ")"),
      CLASS: new RegExp("^\\.(" + P + ")"),
    ...
    }, Q = /^(?:input|select|textarea|button)$/i, K = /^h\d$/i, Z = /^[^{]+\{\s*\[native \w/, ee = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, te = /[+~]/, ne = /'|\\/g, re = new RegExp("\\\\([\\da-f]{1,6}" + B + "?|(" + B + ")|.)","ig");
    try {
      _.apply(L = M.call(N.childNodes), N.childNodes),
    ...
    function ie(e, t, n, r) {
      ...
      if ((t ? t.ownerDocument || t : N) !== T && g(t),
        n = n || [],
        i = (t = t || T).nodeType,
      "string" != typeof e || !e || 1 !== i && 9 !== i && 11 !== i)
        return n;
      if (!r && v) {
        if (11 !== i && (u = ee.exec(e)))
          if (c = u[1]) {
            ...
            if (u[2])
              return _.apply(n, t.getElementsByTagName(e)),
                n;
            if ((c = u[3]) && f.getElementsByClassName)
              return _.apply(n, t.getElementsByClassName(c)),
                n
          }
        if (f.qsa && (!y || !y.test(e))) {
          if (l = s = C,
          ...
          1 === i && "object" !== t.nodeName.toLowerCase()) {
            for (a = p(e),
                   (s = t.getAttribute("id")) ? l = s.replace(ne, "\\$&") : t.setAttribute("id", l),
                   l = "[id='" + l + "'] ",
                   o = a.length; o--; )
              a[o] = l + pe(a[o]);
            u = te.test(e) && de(t.parentNode) || t,
              c = a.join(",")
          }
          if (c)
            try {
              return _.apply(n, u.querySelectorAll(c)),
                n
            } catch (e) {} finally {
    ...
    for (e in f = ie.support = {},
      ...
      g = ie.setDocument = function(e) {
        ...
        return l !== T && 9 === l.nodeType && l.documentElement ? (i = (T = l).documentElement,
        ...
        (f.qsa = Z.test(l.querySelectorAll)) && (se(function(e) {
          i.appendChild(e).innerHTML = "<a id='" + C + "'></a><select id='" + C + "-\f]' msallowcapture=''><option selected=''></option></select>",
          e.querySelectorAll("[msallowcapture^='']").length && y.push("[*^$]=" + B + "*(?:''|\"\")"),
          e.querySelectorAll("[selected]").length || y.push("\\[" + B + "*(?:value|" + O + ")"),
          ...
          se(function(e) {
            ...
            e.querySelectorAll("[name=d]").length && y.push("name" + B + "*[*^$|!~]?="),
            e.querySelectorAll(":enabled").length || y.push(":enabled", ":disabled"),
              e.querySelectorAll("*,:x"),
              y.push(",.*:")
          })),
        (f.matchesSelector = Z.test(s = i.matches || i.webkitMatchesSelector || i.mozMatchesSelector || i.oMatchesSelector || i.msMatchesSelector)) && se(function(e) {
          ...
          b = e || Z.test(i.contains) ? function(e, t) {
          ...
          D = e ? function(e, t) {
              ...
              return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !f.sortDetached && t.compareDocumentPosition(e) === n ? e === l || e.ownerDocument === N && b(N, e) ? -1 : t === l || t.ownerDocument === N && b(N, t) ? 1 : u ? F(u, e) - F(u, t) : 0 : 4 & n ? -1 : 1)
            }
            : function(e, t) {
              if (e === t)
                return c = !0,
              ...
              if (!i || !o)
                return e === l ? -1 : t === l ? 1 : i ? -1 : o ? 1 : u ? F(u, e) - F(u, t) : 0;
              if (i === o)
                return ue(e, t);
              ...
              for (; a[r] === s[r]; )
                r++;
              return r ? ue(a[r], s[r]) : a[r] === N ? -1 : s[r] === N ? 1 : 0
            }
          ,
          l) : T
      }
      ...
      ie.attr = function(e, t) {
        ...
        var n = x.attrHandle[t.toLowerCase()]
          , n = n && j.call(x.attrHandle, t.toLowerCase()) ? n(e, t, !v) : void 0;
        return void 0 !== n ? n : f.attributes || !v ? e.getAttribute(t) : (n = e.getAttributeNode(t)) && n.specified ? n.value : null
      }
      ,
      ie.error = function(e) {
      ...
      (x = ie.selectors = {
        ...
        preFilter: {
          ...
          PSEUDO: function(e) {
            var t, n = !e[6] && e[2];
            return G.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && J.test(n) && (t = p(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
              e[2] = n.slice(0, t)),
              e.slice(0, 3))
          }
        },
        filter: {
          ...
          CLASS: function(e) {
            var t = l[e + " "];
            return t || (t = new RegExp("(^|" + B + ")" + e + "(" + B + "|$)")) && l(e, function(e) {
            ...
            return 1 === h && 0 === m ? function(e) {
              ...
              : function(e, t, n) {
                ...
                if (c) {
                  ...
                  } else if (f && (r = (e[C] || (e[C] = {}))[p]) && r[0] === E)
                    a = r[1];
                  else
                    for (; (o = ++s && o && o[u] || (a = s = 0) || l.pop()) && ((y ? o.nodeName.toLowerCase() !== d : 1 !== o.nodeType) || !++a || (f && ((o[C] || (o[C] = {}))[p] = [E, a]),
                    o !== e)); )
                      ;
        ...
        pseudos: {
          not: ae(function(e) {
            var r = []
              , i = []
              , s = h(e.replace(I, "$1"));
            return s[C] ? ae(function(e, t, n, r) {
          ...
          lang: ae(function(n) {
            return Y.test(n || "") || ie.error("unsupported lang: " + n),
        ...
        ae(function(e, t, n, r) {
          var i, o, a, s = [], l = [], u = t.length, c = e || function(e, t, n) {
            for (var r = 0, i = t.length; r < i; r++)
              ie(e, t[r], n);
            return n
          }(h || "*", n.nodeType ? [n] : n, []), d = !p || !e && h ? c : ge(c, s, p, n, r), f = m ? v || (e ? p : u || g) ? [] : t : d;
          if (m && m(d, f, n, r),
            g)
            for (i = ge(f, l),
                   g(i, [], n, r),
          ...
          if (e) {
            if (v || p) {
              ...
              for (o = f.length; o--; )
                (a = f[o]) && -1 < (i = v ? F(e, a) : s[o]) && (e[i] = !(t[i] = a))
            }
          } else
            f = ge(f === t ? f.splice(u, f.length) : f),
              v ? v(null, t, f, r) : _.apply(t, f)
        })
    }
    function ye(g, v) {
      function e(e, t, n, r, i) {
        var o, a, s, l = 0, u = "0", c = e && [], d = [], f = w, p = e || b && x.find.TAG("*", i), h = E += null == f ? 1 : Math.random() || .1, m = p.length;
        ...
        y && u !== l) {
          ...
          if (e) {
            if (0 < l)
              for (; u--; )
                c[u] || d[u] || (d[u] = H.call(r));
            d = ge(d)
          }
          _.apply(r, d),
          i && !e && 0 < d.length && 1 < l + v.length && ie.uniqueSort(r)
        }
        return i && (E = h,
          w = f),
          c
    ...
    return fe.prototype = x.filters = x.pseudos,
      ...
      h = ie.compile = function(e, t) {
        ...
        if (!o) {
          for (n = (t = t || p(e)).length; n--; )
            ((o = function e(t) {
              for (var r, n, i, o = t.length, a = x.relative[t[0].type], s = a || x.relative[" "], l = a ? 1 : 0, u = he(function(e) {
                return e === r
              }, s, !0), c = he(function(e) {
                return -1 < F(r, e)
                ...
                if (n = x.relative[t[l].type])
                  ...
                  if ((n = x.filter[t[l].type].apply(null, t[l].matches))[C]) {
                    for (i = ++l; i < o && !x.relative[t[i].type]; i++)
                      ;
                    return ve(1 < l && me(d), 1 < l && pe(t.slice(0, l - 1).concat({
                      value: " " === t[l - 2].type ? "*" : ""
                    })).replace(I, "$1"), n, l < i && e(t.slice(l, i)), i < o && e(t = t.slice(i)), i < o && pe(t))
                  }
                  d.push(n)
                }
              return me(d)
      ...
      m = ie.select = function(e, t, n, r) {
        ...
        if (n = n || [],
        1 === c.length) {
          if (2 < (o = c[0] = c[0].slice(0)).length && "ID" === (a = o[0]).type && f.getById && 9 === t.nodeType && v && x.relative[o[1].type]) {
            if (!(t = (x.find.ID(a.matches[0].replace(re, d), t) || [])[0]))
              return n;
            u && (t = t.parentNode),
          ...
          for (i = G.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i],
            !x.relative[s = a.type]); )
            if ((l = x.find[s]) && (r = l(a.matches[0].replace(re, d), te.test(o[0].type) && de(t.parentNode) || t))) {
              if (o.splice(i, 1),
                !(e = r.length && pe(o)))
                return _.apply(n, r),
                  n;
        ...
        return (u || h(e, c))(r, t, !v, n, te.test(e) && de(t.parentNode) || t),
          n
      }
      ,
  ...
  var y = w.expr.match.needsContext
    , b = /^<(\w+)\s*\/?>(?:<\/\1>|)$/
    , x = /^.[^:#\[\.,]*$/;
  function T(e, n, r) {
    if (w.isFunction(n))
  ...
  w.filter = function(e, t, n) {
    ...
    w.fn.extend({
      ...
      is: function(e) {
        return !!T(this, "string" == typeof e && y.test(e) ? w(e) : e || [], !1).length
      }
    });
  var C = h.document
    , N = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;
  ...
  w.extend({
    ...
    w.fn.extend({
      ...
      closest: function(e, t) {
        for (var n, r = 0, i = this.length, o = [], a = y.test(e) || "string" != typeof e ? w(e, t || this.context) : 0; r < i; r++)
  ...
  var D, j = /\S+/g, L = {};
  function H() {
    C.addEventListener ? (C.removeEventListener("DOMContentLoaded", q, !1),
      h.removeEventListener("load", q, !1)) : (C.detachEvent("onreadystatechange", q),
      h.detachEvent("onload", q))
  }
  function q() {
  ...
  w.Callbacks = function(i) {
    ...
    function r(e) {
      ...
      o = !1,
      c && (d ? d.length && r(d.shift()) : t ? c = [] : f.disable())
    }
    var o, t, a, s, l, u, c = [], d = !i.once && [], f = {
      add: function() {
        var e;
        return c && (e = c.length,
          function r(e) {
      ...
      fireWith: function(e, t) {
        return !c || a && !d || (t = [e, (t = t || []).slice ? t.slice() : t],
          o ? d.push(t) : r(t)),
          this
      },
      fire: function() {
    ...
    w.ready.promise = function(e) {
      if (!D)
        ...
        "complete" === C.readyState)
          ...
          C.addEventListener("DOMContentLoaded", q, !1),
            h.addEventListener("load", q, !1);
        else {
          C.attachEvent("onreadystatechange", q),
  ...
  function R(e, t, n, r) {
    if (w.acceptData(e)) {
      ...
      if (l && s[l] && (r || s[l].data) || void 0 !== n || "string" != typeof t)
        return s[l = l || (a ? e[o] = d.pop() || w.guid++ : o)] || (s[l] = a ? {} : {
          toJSON: w.noop
        }),
  ...
  function W(e, t, n) {
    if (w.acceptData(e)) {
      ...
      if (a[s]) {
        ...
        (n || (delete a[s].data,
          P(a[s]))) && (o ? w.cleanData([e], !0) : v.deleteExpando || a != a.window ? delete a[s] : a[s] = null)
      }
    }
  }
  w.extend({
    ...
    w.extend({
      queue: function(e, t, n) {
        var r;
        return e ? (r = w._data(e, t = (t || "fx") + "queue"),
  ...
  w.event = {
    ...
    add: function(e, t, n, r, i) {
      ...
      if (h)
        for (n.handler && (n = (s = n).handler,
          ...
          (p = o[d]) || ((p = o[d] = []).delegateCount = 0,
          l.setup && !1 !== l.setup.call(e, r, f, u) || (e.addEventListener ? e.addEventListener(d, u, !1) : e.attachEvent && e.attachEvent("on" + d, u))),
      ...
      if (g && (c = g.events)) {
        for (u = (t = (t || "").match(j) || [""]).length; u--; )
          if (p = m = (s = Q.exec(t[u]) || [])[1],
            ...
            l && !f.length && (d.teardown && !1 !== d.teardown.call(e, h, g.handle) || w.removeEvent(e, p, g.handle),
              delete c[p])
          } else
            for (p in c)
    ...
    trigger: function(e, t, n, r) {
      var i, o, a, s, l, u, c = [n || C], d = g.call(e, "type") ? e.type : e, f = g.call(e, "namespace") ? e.namespace.split(".") : [], p = l = n = n || C;
      if (3 !== n.nodeType && 8 !== n.nodeType && !G.test(d + w.event.triggered) && (0 <= d.indexOf(".") && (d = (f = d.split(".")).shift(),
        f.sort()),
        o = d.indexOf(":") < 0 && "on" + d,
        (e = e[w.expando] ? e : new w.Event(d,"object" == typeof e && e)).isTrigger = r ? 2 : 3,
        e.namespace = f.join("."),
    ...
    special: {
      ...
      click: {
        trigger: function() {
          return w.nodeName(this, "input") && "checkbox" === this.type && this.click ? (this.click(),
            !1) : void 0
        },
        _default: function(e) {
    ...
    w.Event = function(e, t) {
      return this instanceof w.Event ? (e && e.type ? (this.originalEvent = e,
        this.type = e.type,
      ...
      t && w.extend(this, t),
        ...
        void (this[w.expando] = !0)) : new w.Event(e,t)
    }
    ,
    w.Event.prototype = {
  ...
  v.changeBubbles || (w.event.special.change = {
    setup: function() {
      return V.test(this.nodeName) ? ("checkbox" !== this.type && "radio" !== this.type || (w.event.add(this, "propertychange._change", function(e) {
  ...
  function ve(e, t) {
    ...
    if (!o)
      for (o = [],
        ...
        !t || w.nodeName(r, t) ? o.push(r) : w.merge(o, ve(r, t));
  ...
  me.optgroup = me.option,
    ...
    w.extend({
      clone: function(e, t, n) {
        ...
        if (v.html5Clone || w.isXMLDoc(e) || !ie.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (ge.innerHTML = e.outerHTML,
          ge.removeChild(o = ge.firstChild)),
          !(v.noCloneEvent && v.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e)))
          for (r = ve(o),
                 s = ve(e),
                 a = 0; null != (i = s[a]); ++a)
            r[a] && function(e, t) {
              ...
              if (1 === t.nodeType) {
                ...
                v.html5Clone && e.innerHTML && !w.trim(t.innerHTML) && (t.innerHTML = e.innerHTML)) : "input" === n && U.test(e.type) ? (t.defaultChecked = t.checked = e.checked,
        ...
        if (t)
          if (n)
            ...
            Ce(e, o);
        return 0 < (r = ve(o, "script")).length && Te(r, !l && ve(e, "script")),
          r = s = i = null,
          o
      },
      buildFragment: function(e, t, n, r) {
        for (var i, o, a, s, l, u, c, d = e.length, f = te(t), p = [], h = 0; h < d; h++)
          if ((o = e[h]) || 0 === o)
            if ("object" === w.type(o))
        ...
        for (s && f.removeChild(s),
             v.appendChecked || w.grep(ve(p, "input"), ye),
               h = 0; o = p[h++]; )
      ...
      cleanData: function(e, t) {
        for (var n, r, i, o, a = 0, s = w.expando, l = w.cache, u = v.deleteExpando, c = w.event.special; null != (n = e[a]); a++)
    ...
    w.fn.extend({
      ...
      remove: function(e, t) {
        for (var n, r = e ? w.filter(e, this) : this, i = 0; null != (n = r[i]); i++)
          t || 1 !== n.nodeType || w.cleanData(ve(n)),
          n.parentNode && (t && w.contains(n.ownerDocument, n) && Te(ve(n, "script")),
            n.parentNode.removeChild(n));
        return this
      },
      empty: function() {
        for (var e, t = 0; null != (e = this[t]); t++) {
          for (1 === e.nodeType && w.cleanData(ve(e, !1)); e.firstChild; )
      ...
      domManip: function(n, r) {
        ...
        1 === s.childNodes.length && (s = e),
          e)) {
          for (i = (o = w.map(ve(s, "script"), xe)).length; l < u; l++)
            t = s,
            l !== d && (t = w.clone(t, !0, !0),
            i && w.merge(o, ve(t, "script"))),
              r.call(this[l], t, l);
          if (i)
            for (a = o[o.length - 1].ownerDocument,
                   ...
                   l = 0; l < i; l++)
              t = o[l],
              fe.test(t.type || "") && !w._data(t, "globalEval") && w.contains(a, t) && (t.src ? w._evalUrl && w._evalUrl(t.src) : w.globalEval((t.text || t.textContent || t.innerHTML || "").replace(he, "")));
          s = e = null
        }
        return this
      }
  ...
  ;
  var De, je, Le, He, qe, _e, Me = /^margin/, Fe = new RegExp("^(" + z + ")(?!px)[a-z%]+$","i"), Oe = /^(top|right|bottom|left)$/;
  function Be(t, n) {
    return {
      get: function() {
        var e = t();
  ...
  function Pe() {
    ...
    h.getComputedStyle && (Le = "1%" !== (h.getComputedStyle(e, null) || {}).top,
      ...
      e.style.width = "1px",
      _e = !parseFloat((h.getComputedStyle(n, null) || {}).marginRight),
      e.removeChild(n)),
      e.innerHTML = "<table><tr><td></td><td>t</td></tr></table>",
      (n = e.getElementsByTagName("td"))[0].style.cssText = "margin:0;border:0;padding:0;display:none",
    (qe = 0 === n[0].offsetHeight) && (n[0].style.display = "",
      n[1].style.display = "none",
      qe = 0 === n[0].offsetHeight),
      r.removeChild(t))
  }
  ...
  function Ke(e, t, n) {
    var r = !0
      ...
      , o = De(e)
      , a = v.boxSizing && "border-box" === w.css(e, "boxSizing", !1, o);
    if (i <= 0 || null == i) {
  ...
  w.extend({
    ...
    w.each(["height", "width"], function(e, i) {
      w.cssHooks[i] = {
        get: function(e, t, n) {
          return t ? $e.test(w.css(e, "display")) && 0 === e.offsetWidth ? w.swap(e, Xe, function() {
            return Ke(e, i, n)
          }) : Ke(e, i, n) : void 0
        },
        set: function(e, t, n) {
          var r = n && De(e);
          return Ge(0, t, n ? Qe(e, i, n, v.boxSizing && "border-box" === w.css(e, "boxSizing", !1, r), r) : 0)
        }
      }
    }),
  v.opacity || (w.cssHooks.opacity = {
    ...
    w.cssHooks.marginRight = Be(v.reliableMarginRight, function(e, t) {
      return t ? w.swap(e, {
  ...
  var et, tt, nt, rt, it = /^(?:toggle|show|hide)$/, ot = new RegExp("^(?:([+-])=|)(" + z + ")([a-z%]*)$","i"), at = /queueHooks$/, st = [function(t, e, n) {
    var r, i, o, a, s, l, u, c = this, d = {}, f = t.style, p = t.nodeType && $(t), h = w._data(t, "fxshow");
    for (r in n.queue || (null == (s = w._queueHooks(t, "fx")).unqueued && (s.unqueued = 0,
        l = s.empty.fire,
    ...
    1 === t.nodeType && ("height"in e || "width"in e) && (n.overflow = [f.overflow, f.overflowX, f.overflowY],
      u = w.css(t, "display"),
    "inline" === ("none" === u ? w._data(t, "olddisplay") || Ae(t.nodeName) : u) && "none" === w.css(t, "float") && (v.inlineBlockNeedsLayout && "inline" !== Ae(t.nodeName) ? f.zoom = 1 : f.display = "inline-block")),
    ...
    v.shrinkWrapBlocks() || c.always(function() {
      ...
      if (i = e[r],
        ...
        u = void 0;
    if (w.isEmptyObject(d))
      "inline" === ("none" === u ? Ae(t.nodeName) : u) && (f.display = u);
    else
    ...
    "*": [function(e, t) {
      ...
      if (o && o[3] !== i)
        for (i = i || o[3],
               t = t || [],
               o = +r || 1; w.style(n.elem, e, (o /= a = a || ".5") + i),
             a !== (a = n.cur() / r) && 1 !== a && --s; )
          ;
  ...
  w.Animation = w.extend(ft, {
    ...
    v.input = "" === z.getAttribute("value"),
    z.value = "t",
    z.setAttribute("type", "radio"),
    v.radioValue = "t" === z.value;
  var pt = /\r/g;
  w.fn.extend({
    val: function(t) {
      var n, e, r, i = this[0];
        ...
        select: {
          get: function(e) {
            for (var t, n = e.options, r = e.selectedIndex, i = "select-one" === e.type || r < 0, o = i ? null : [], a = i ? r + 1 : n.length, s = r < 0 ? a : i ? r : 0; s < a; s++)
              if (!(!(t = n[s]).selected && s !== r || (v.optDisabled ? t.disabled : null !== t.getAttribute("disabled")) || t.parentNode.disabled && w.nodeName(t.parentNode, "optgroup"))) {
                if (t = w(t).val(),
                  i)
                  return t;
                o.push(t)
  ...
  var ht, mt, gt = w.expr.attrHandle, vt = /^(?:checked|selected)$/i, yt = v.getSetAttribute, bt = v.input;
  w.fn.extend({
    attr: function(e, t) {
    ...
    w.extend({
      attr: function(e, t, n) {
        ...
        if (e && 3 !== o && 8 !== o && 2 !== o)
          return typeof e.getAttribute == M ? w.prop(e, t, n) : (1 === o && w.isXMLDoc(e) || (t = t.toLowerCase(),
            ...
            void 0 === n ? r && "get"in r && null !== (i = r.get(e, t)) ? i : null == (i = w.find.attr(e, t)) ? void 0 : i : null !== n ? r && "set"in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""),
      ...
      removeAttr: function(e, t) {
        ...
        if (o && 1 === e.nodeType)
          for (; n = o[i++]; )
            r = w.propFix[n] || n,
              w.expr.match.bool.test(n) ? bt && yt || !vt.test(n) ? e[r] = !1 : e[w.camelCase("default-" + n)] = e[r] = !1 : w.attr(e, n, ""),
    ...
    mt = {
      set: function(e, t, n) {
        return !1 === t ? w.removeAttr(e, n) : bt && yt || !vt.test(n) ? e.setAttribute(!yt && w.propFix[n] || n, n) : e[w.camelCase("default-" + n)] = e[n] = !0,
          n
      }
    },
  ...
  bt && yt || (w.attrHooks.value = {
    set: function(e, t, n) {
      return w.nodeName(e, "input") ? void (e.defaultValue = t) : ht && ht.set(e, t, n)
    }
  }),
  yt || (ht = {
    set: function(e, t, n) {
  ...
  ;
  var kt, St, At = /#.*$/, Dt = /([?&])_=[^&]*/, jt = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Lt = /^(?:GET|HEAD)$/, Ht = /^\/\//, qt = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, _t = {}, Mt = {}, Ft = "*/".concat("*");
  try {
    St = location.href
  } catch (e) {
  ...
  kt = qt.exec(St.toLowerCase()) || [],
    w.extend({
      ...
      ajax: function(e, t) {
        "object" == typeof e && (t = e,
          e = void 0);
        var n, l, u, c, d, f, r, p = w.ajaxSetup({}, t = t || {}), h = p.context || p, m = p.context && (h.nodeType || h.jquery) ? w(h) : w.event, g = w.Deferred(), v = w.Callbacks("once memory"), y = p.statusCode || {}, i = {}, o = {}, b = 0, a = "canceled", x = {
          readyState: 0,
        ...
        2 === b)
          return x;
        for (n in (d = w.event && p.global) && 0 == w.active++ && w.event.trigger("ajaxStart"),
        ...
        (p.data && p.hasContent && !1 !== p.contentType || t.contentType) && x.setRequestHeader("Content-Type", p.contentType),
          x.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Ft + "; q=0.01" : "") : p.accepts["*"]),
          p.headers)
        ...
        function s(e, t, n, r) {
          ...
          n && (a = function(e, t, n) {
            ...
            x.statusCode(y),
            y = void 0,
          d && m.trigger(r ? "ajaxSuccess" : "ajaxError", [x, p, r ? i : o]),
            v.fireWith(h, [x, s]),
  ...
  h.attachEvent && h.attachEvent("onunload", function() {
    ...
    v.cors = !!z && "withCredentials"in z,
  (z = v.ajax = !!z) && w.ajaxTransport(function(l) {
    var u;
  ...
  w.ajaxSetup({
    ...
    w.ajaxPrefilter("json jsonp", function(e, t, n) {
      ...
      return a || "jsonp" === e.dataTypes[0] ? (r = e.jsonpCallback = w.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback,
  ...
  w.offset = {
    ...
    w.each(["top", "left"], function(e, n) {
      w.cssHooks[n] = Be(v.pixelPosition, function(e, t) {
        return t ? (t = je(e, n),
          Fe.test(t) ? w(e).position()[n] + "px" : t) : void 0
      })
    }),
    w.each({
      Height: "height",
...
!function(e) {
  ...
  function r(e) {
    ...
    var r = /(edge)\/([\w.]+)/.exec(e) || /(opr)[\/]([\w.]+)/.exec(e) || /(chrome)[ \/]([\w.]+)/.exec(e) || /(version)(applewebkit)[ \/]([\w.]+).*(safari)[ \/]([\w.]+)/.exec(e) || /(webkit)[ \/]([\w.]+).*(version)[ \/]([\w.]+).*(safari)[ \/]([\w.]+)/.exec(e) || /(webkit)[ \/]([\w.]+)/.exec(e) || /(opera)(?:.*version|)[ \/]([\w.]+)/.exec(e) || /(msie) ([\w.]+)/.exec(e) || 0 <= e.indexOf("trident") && /(rv)(?::| )([\w.]+)/.exec(e) || e.indexOf("compatible") < 0 && /(mozilla)(?:.*? rv:([\w.]+)|)/.exec(e) || []
      , o = /(ipad)/.exec(e) || /(ipod)/.exec(e) || /(iphone)/.exec(e) || /(kindle)/.exec(e) || /(silk)/.exec(e) || /(android)/.exec(e) || /(windows phone)/.exec(e) || /(win)/.exec(e) || /(mac)/.exec(e) || /(linux)/.exec(e) || /(cros)/.exec(e) || /(playbook)/.exec(e) || /(bb)/.exec(e) || /(blackberry)/.exec(e) || []
      , e = {}
      , o = {
      browser: r[5] || r[3] || r[1] || "",
      version: r[2] || r[4] || "0",
    ...
    return o.browser && (e[o.browser] = !0,
      e.version = o.version,
      e.versionNumber = parseInt(o.versionNumber, 10)),
    o.platform && (e[o.platform] = !0),
    (e.android || e.bb || e.blackberry || e.ipad || e.iphone || e.ipod || e.kindle || e.playbook || e.silk || e["windows phone"]) && (e.mobile = !0),
    (e.cros || e.mac || e.linux || e.win) && (e.desktop = !0),
    (e.chrome || e.opr || e.safari) && (e.webkit = !0),
    (e.rv || e.edge) && (e[o.browser = "msie"] = !0),
    e.safari && e.blackberry && (e[o.browser = "blackberry"] = !0),
    e.safari && e.playbook && (e[o.browser = "playbook"] = !0),
    e.bb && (e[o.browser = "blackberry"] = !0),
    e.opr && (e[o.browser = "opera"] = !0),
    e.safari && e.android && (e[o.browser = "android"] = !0),
    e.safari && e.kindle && (e[o.browser = "kindle"] = !0),
    e.safari && e.silk && (e[o.browser = "silk"] = !0),
      e.name = o.browser,
      e.platform = o.platform,
      e
  }
  return window.jQBrowser = r(window.navigator.userAgent),
