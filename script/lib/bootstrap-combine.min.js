!function(n) {
  ...
  function r(o) {
    o && 3 === o.which || (n(".dropdown-backdrop").remove(),
      n(a).each(function() {
        var t = n(this)
          , e = s(t)
          , i = {
        ...
        o.isDefaultPrevented() || (t.attr("aria-expanded", "false"),
          e.removeClass("open").trigger(n.Event("hidden.bs.dropdown", i)))))
      }))
  }
  function o(t) {
    ...
    o.prototype.toggle = function(t) {
      ...
      if (!e.is(".disabled, :disabled")) {
        ...
        if (r(),
          ...
          if (i.trigger(t = n.Event("show.bs.dropdown", o)),
            t.isDefaultPrevented())
            return;
          e.trigger("focus").attr("aria-expanded", "true"),
            i.toggleClass("open").trigger(n.Event("shown.bs.dropdown", o))
        }
        return !1
      }
    }
    ...
    p.VERSION = "3.3.7",
      ...
      p.prototype.init = function(t, e, i) {
        ...
        for (var o = this.options.trigger.split(" "), n = o.length; n--; ) {
          var s, r = o[n];
          "click" == r ? this.$element.on("click." + this.type, this.options.selector, l.proxy(this.toggle, this)) : "manual" != r && (s = "hover" == r ? "mouseleave" : "focusout",
            this.$element.on(("hover" == r ? "mouseenter" : "focusin") + "." + this.type, this.options.selector, l.proxy(this.enter, this)),
            this.$element.on(s + "." + this.type, this.options.selector, l.proxy(this.leave, this)))
        }
      ...
      ,
      p.prototype.getOptions = function(t) {
      ...
      p.prototype.show = function() {
        var e, t, i, o, n, s, r, a = l.Event("show.bs." + this.type);
        ...
        !a.isDefaultPrevented() && i && (t = (e = this).tip(),
        ...
        (n = (o = /\s?auto?\s?/i).test(r)) && (r = r.replace(o, "") || "top"),
          t.detach().css({
            top: 0,
            left: 0,
            display: "block"
        ...
        n && (o = r,
          ...
          r = "bottom" == r && a.bottom + s > n.bottom ? "top" : "top" == r && a.top - s < n.top ? "bottom" : "right" == r && a.right + i > n.width ? "left" : "left" == r && a.left - i < n.left ? "right" : r,
          t.removeClass(o).addClass(r)),
          s = this.getCalculatedOffset(r, a, i, s),
          ...
          ,
          l.support.transition && this.$tip.hasClass("fade") ? t.one("bsTransitionEnd", r).emulateTransitionEnd(p.TRANSITION_DURATION) : r()))
      }
      ,
      p.prototype.applyPlacement = function(t, e) {
        var i = this.tip()
          , o = i[0].offsetWidth
          , n = i[0].offsetHeight
      ...
      p.prototype.hide = function(t) {
        ...
        if (this.$element.trigger(n),
          ...
          return o.removeClass("in"),
            l.support.transition && o.hasClass("fade") ? o.one("bsTransitionEnd", e).emulateTransitionEnd(p.TRANSITION_DURATION) : e(),
            this.hoverState = null,
            this
      }
      ,
      ...
      ,
      p.prototype.getPosition = function(t) {
      ...
      p.prototype.getViewportAdjustedDelta = function(t, e, i, o) {
        ...
        return /right|left/.test(t) ? (t = e.top - r - a.scroll,
          s = e.top + r - a.scroll + o,
          t < a.top ? n.top = a.top - t : s > a.top + a.height && (n.top = a.top + a.height - s)) : (s = e.left - r,
          i = e.left + r + i,
          s < a.left ? n.left = a.left - s : i > a.right && (n.left = a.left + a.width - i)),
          n
      }
      ,
    ...
    l.fn.tooltip = function(o) {
      return this.each(function() {
        var t = l(this)
          , e = t.data("bs.tooltip")
          , i = "object" == typeof o && o;
        !e && /destroy|hide/.test(o) || (e || t.data("bs.tooltip", e = new p(this,i)),
        "string" == typeof o && e[o]())
      })
    }
      ,
      l.fn.tooltip.Constructor = p,
  ...
  function(r) {
    ...
    a.VERSION = "3.3.7",
      ...
      a.prototype.show = function() {
        var t, e, i, o = this.element, n = o.closest("ul:not(.dropdown-menu)"), s = (s = o.data("target")) || (s = o.attr("href")) && s.replace(/.*(?=#[^\s]*$)/, "");
        o.parent("li").hasClass("active") || (t = n.find(".active:last a"),
          ...
          t.trigger(e),
          o.trigger(i),
        i.isDefaultPrevented() || e.isDefaultPrevented() || (s = r(s),
      ...
      a.prototype.activate = function(t, e, i) {
        ...
        n.length && s ? n.one("bsTransitionEnd", o).emulateTransitionEnd(a.TRANSITION_DURATION) : o(),
          n.removeClass("in")
      }
    ;
    var t = r.fn.tab;
  ...
  function(r) {
    ...
    a.VERSION = "3.3.7",
      ...
      a.prototype.getState = function(t, e, i, o) {
        ...
        var a = null == this.affixed
          , s = a ? n : s.top;
        return null != i && n <= i ? "top" : null != o && t - o <= s + (a ? r : e) && "bottom"
      }
      ,
      ...
      a.prototype.checkPosition = function() {
        if (this.$element.is(":visible")) {
          var t = this.$element.height()
            ...
            , i = e.top
            , o = e.bottom
            , n = Math.max(r(document).height(), r(document.body).height());
          ...
          if (this.affixed != s) {
            ...
            e = "affix" + (s ? "-" + s : ""),
              i = r.Event(e + ".bs.affix");
            if (this.$element.trigger(i),
              i.isDefaultPrevented())
              return;
            this.affixed = s,
              this.unpin = "bottom" == s ? this.getPinnedOffset() : null,
              this.$element.removeClass(a.RESET).addClass(e).trigger(e.replace("affix", "affixed") + ".bs.affix")
          }
  ...
  function(n) {
    ...
    function s(o) {
      return this.each(function() {
        var t = n(this)
          ...
          , i = n.extend({}, r.DEFAULTS, t.data(), "object" == typeof o && o);
    ...
    function r(t, e) {
      this.$element = n(t),
        this.options = n.extend({}, r.DEFAULTS, e),
        ...
        if (!this.transitioning && !this.$element.hasClass("in")) {
          ...
          if (!(t && t.length && (o = t.data("bs.collapse")) && o.transitioning)) {
            ...
            if (this.$element.trigger(e),
              ...
              this.$element.one("bsTransitionEnd", n.proxy(o, this)).emulateTransitionEnd(r.TRANSITION_DURATION)[i](this.$element[0][t])
            }
          }
        }
      }
    ...
    var t = n.fn.collapse;
    n.fn.collapse = s,
      n.fn.collapse.Constructor = r,
      n.fn.collapse.noConflict = function() {
        return n.fn.collapse = t,
          this
      }
      ,
  ...
  function(n) {
    ...
    function e(i) {
      return this.each(function() {
        ...
        e || t.data("bs.scrollspy", e = new o(this,"object" == typeof i && i)),
        "string" == typeof i && e[i]()
      })
    }
    o.VERSION = "3.3.7",
